#!/usr/bin/env python3
"""
General analysis pipeline for battery results.

Usage:
    python analyze_battery_results.py --day 271
    python analyze_battery_results.py --day 301
    python analyze_battery_results.py --day 332
    python analyze_battery_results.py --day 362

Reads  : ../battery_{COUNTRY}_day_{DAY}_tol_0.05_384_installed_capacity.csv
Outputs: ../results/battery_CI_day{DAY}_tol005_384.csv
         ../results/boxplot_day{DAY}_tol005_384.png
         ../results/synergy_heatmap_day{DAY}_tol005_384.png
         ../results/decision_tree_day{DAY}_tol005_384.png
"""
...
ROOT        = ".."
RESULTS_DIR = "../results"
PATTERN     = os.path.join(ROOT, f"battery_*_day_{DAY}_tol_0.05_384_installed_capacity.csv")
TAG         = f"day{DAY}_tol005_384"

print(f"\n=== Day {DAY} | tol=0.05 | 384 MW installed capacity ===\n")
...
ax.set_title(f"Synergy Ratio by Region\n(day_{DAY}, tol=0.05, 384 MW installed capacity)", fontsize=13)
...
ax.set_title(
    f"Mean Synergy Ratio by Country\n(day_{DAY}, tol=0.05, 384 MW installed capacity)",
    fontsize=15, pad=14,
)
...
plt.title(f"Decision Tree — Synergy Ratio (day_{DAY}, tol=0.05, 384 MW)", fontsize=13)
plt.tight_layout()

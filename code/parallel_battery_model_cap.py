...
for i in set_numbers:
    ...
    try:
        ...
        res_wind = run_optimization_and_collect_results("wind only", wind, capacity=3.84*wind_capacity)
        res_solar = run_optimization_and_collect_results("pv only", solar, capacity=3.84*solar_capacity)
        res_combined = run_optimization_and_collect_results("combined", combined, capacity=3.84*combined_capacity)

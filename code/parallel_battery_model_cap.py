...
parser.add_argument('--tol', type=float, default=0.05, help='Reliability tolerance epsilon (e.g. 0.01, 0.05, 0.10)')
parser.add_argument('--forecast_day', type=int, default=271, help='1-indexed forecast day (e.g. 271, 301, 332, 362)')
...
if all_run_results:
    ...
    output_filename = f'battery_{country}_day_{args.forecast_day}_tol_{tol}_100_installed_capacity.csv'
